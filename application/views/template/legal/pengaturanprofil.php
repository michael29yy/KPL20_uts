    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column" style="background-image: url(<?= base_url();?>assets/img/default_img/default_bg.jpg); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
            ...
            <div id="content">
                ...
                <!-- Content Body -->
                <div class="card m-3 shadow bg-gradient-light">
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class=" col-md-11">
                        <div class="well profile centered">

                            <div class=" form-row mx-auto centered" style="border-top:1px solid rgba(0,0,0,0.1);">
                                <div class="col-xs-12 col-sm-4 mx-auto mt-5">

                                    <?php if($this->session->flashdata('notm')):?>
                                    <div class="alert alert-danger">
                                        <?= $this->session->flashdata('notm');?></span>
                                    </div>
                                    <?php endif?>
                                    ...
                                    <?php endif?>
                                    <?php if($this->session->flashdata('sccm')):?>
                                    <div class="alert alert-success">
                                        <?= $this->session->flashdata('sccm');?>
                                    </div>
                                    <?php endif?>
                                    
                                    <h2><?= $user['nama']; ?></h2>
                                    <p><strong>NIK: </strong> <?= $user['username']; ?> </p>
                                    <p><strong>Jabatan: </strong> <?= $user['jabatan']; ?> </p>
                                    <p><strong>Email: </strong> <?= $user['email']; ?> </p>
                                </div>
                                <div class="col-xs-12 col-sm-4 mx-auto mt-5">
                                    <figure>
                                        <img src="<?= base_url(); ?>assets/img/logo_perusahaan/L_Rasita.png" alt="" class="img-profile rounded-circle img-responsive" style="width: 100%;">
                                    </figure>
                                </div>
                            </div>

                            <div class="form-col mx-auto centered mb-3" style="border-top:9px solid rgba(0,0,2,0.1);">

                                <div class="col-sm-4 emphasis mx-auto mt-3" style="border-top: 4px solid transparent;">
                                    <a data-toggle="modal" data-target="#editemail" href='#' class="btn btn-success btn-block"><span class="fa fa-plus-circle"></span> Edit Email </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modaleditemail">Edit Email</h5>
                                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="<?= base_url() ;?>Pengaturanprofil/edit_email" enctype="multipart/form-data" method="POST">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <label>Nama Pengguna : </label>
                                                                <input class="form-control" type="text" name="nama_pengguna" value="<?= $user['nama']?>" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <label>Email Baru : </label>
                                                                <input class="form-control" type="text" name="email" placeholder="email baru" value="<?= $user['email']?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <button class="form-control btn-primary" type="submit" name="updateemail">Update</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <div class="col-sm-4 emphasis mx-auto mb-3" style="border-top: 4px solid transparent;">
                                    <a data-toggle="modal" data-target="#editpassword" href='#' class='btn btn-danger btn-block'><span class="fa fa-key"></span> Edit Password </a>
                                    ...
                                    <div class="modal fade" id="editpassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editpassword">Edit Password</h5>
                                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="<?= base_url() ;?>Pengaturanprofil/edit_password" enctype="multipart/form-data" method="POST">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <button class="form-control btn-primary" type="submit" name="updatepassword">Update</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
